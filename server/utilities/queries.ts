...
import { AccountNotifications, Accounts, Delete_account_notifications_delete, Insert_account_notifications_new, Select_account_notifications_from_account, Update_account_notifications_mark_read } from './tables';
...
export type Queries = {
    ...
    'account-notifications/delete': [[Delete_account_notifications_delete], unknown];
    'account-notifications/from-account': [[Select_account_notifications_from_account], AccountNotifications];
    'account-notifications/mark-read': [[Update_account_notifications_mark_read], unknown];
