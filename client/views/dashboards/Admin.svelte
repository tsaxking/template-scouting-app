...
>
    <Page {active} {domain} title="dashboard" bind:loading><Dashboard /></Page>
    <Page {active} {domain} title="accounts" bind:loading><Accounts /></Page>
    <Page {active} {domain} title="roles" bind:loading><Roles /></Page>
</Main>
