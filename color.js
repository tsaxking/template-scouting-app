...
class Color {
    ...
    get rgba() {
        return Object.assign(Object.assign({}, this.rgb), { values: [...this.rgb.values, this.a], toString: () => `rgba(${this.r}, ${this.g}, ${this.b}, ${this.a})`, setAlpha: this.setAlpha });
    }
    get hsl() {
        let h, s, l;
        const r = this.r / 255;
    ...
    get hsla() {
        return Object.assign(Object.assign({}, this.hsl), { values: [...this.hsl.values, this.a], toString: () => `hsla(${this.hsl.values[0]}, ${this.hsl.values[1]}, ${this.hsl.values[2]}, ${this.a})`, setAlpha: this.setAlpha, set: (hue, saturation, lightness, alpha) => {
    ...
    get hexa() {
        ...
        return Object.assign(Object.assign({}, this.hex), { values: [r, g, b, a], toString: () => `#${r}${g}${b}${a}`, setAlpha: this.setAlpha });
    }
    // global setters
    /**
     * @param {any} hue
