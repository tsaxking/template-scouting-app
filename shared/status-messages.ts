...
export const messages: {
    ...
    message: 'Your match submission failed, it has been saved onto the event server, but it did not submit to the tatorscout.org server. You may have lost internet access',
    color: 'warning',
    code: 404,
    instructions: '',
},
...
export type ServerRequestStatusId = 'match-error'
	| 'match-submitted';
...
export type TabletStatusId = 'not-found'
	| 'aborted'
	| 'submitted'
	| 'state-updated';
